...
MERCHANT_RULES = {
    ...
    "uber": taxonomy_path(DefaultCategorySlug.TRANSPORT, "cab"),
    "ola": taxonomy_path(DefaultCategorySlug.TRANSPORT, "cab"),
...
EXPENSE_TEXT_RULES = [
    ...
    (("cab", "taxi", "uber", "ola"), taxonomy_path(DefaultCategorySlug.TRANSPORT, "cab")),
    (("petrol", "diesel", "fuel"), taxonomy_path(DefaultCategorySlug.TRANSPORT, "fuel")),
    (("metro", "bus", "train", "public transit"), taxonomy_path(DefaultCategorySlug.TRANSPORT, "public_transit")),
    (("flight", "flights", "airfare"), taxonomy_path(DefaultCategorySlug.TRANSPORT, "flights")),
    (("travelling", "traveling", "travel", "transport", "commute"), taxonomy_path(DefaultCategorySlug.TRANSPORT, "other")),
