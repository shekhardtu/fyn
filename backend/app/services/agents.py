...
def build_operator(
    ...
    *,
    ...
    effectful_operation_rules = ([
        ...
        "The authenticated workflow context's defaultCurrency is authoritative. When the current message does not explicitly name a currency, use that default without asking for confirmation and leave an optional currency override null. Override it only when the current message explicitly contains a currency symbol, code, or name.",
